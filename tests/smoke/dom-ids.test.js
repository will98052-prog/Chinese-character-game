...
describe('html shell', () => {
  it('contains required app elements', () => {
    ...
    expect(html).toContain('id="statsStrip"')
    expect(html).toContain('id="statAnswered"')
    expect(html).toContain('id="statCorrect"')
    expect(html).toContain('id="statIncorrect"')
    expect(html).toContain('id="statAccuracy"')
